...
axChord = axes('Parent',fig, 'Position',[.07,.47,.295,.52]);
...
CC = chordChart(axChord, adjMat, 'RowName',rowName, 'ColName',colName);
...
set(axChord, 'XLim',[-1.15,1.15], 'YLim',[-1.15,1.15], 'Color','none')
